...
# === Coeficientes completos del modelo ARDL (significativos y no significativos) ===
ARDL_COEF = {
    'const': 4.5626,
...
# === Coeficientes completos del modelo ECM ===
ECM_COEF = {
    'const': -0.0060,
    'D_LN_ITCMR': 0.1317,
    'D_GS10': 0.0021,
...
def index():
    ...
    <form action="/calcular_ardl" method="get">
      ...
      <label>LN_ITCMR.L0: <input type="number" step="any" name="itcmr_0"></label><br>
      <label>LN_ITCMR.L1: <input type="number" step="any" name="itcmr_1"></label><br>
      <label>GS10.L0: <input type="number" step="any" name="gs10_0"></label><br>
      <label>LN_VP.L0: <input type="number" step="any" name="vp_0"></label><br><br>
...
def calcular_ardl():
    try:
        ...
        x4 = float(request.args.get('itcmr_0', 0))
        x5 = float(request.args.get('itcmr_1', 0))
        x6 = float(request.args.get('gs10_0', 0))
        x7 = float(request.args.get('vp_0', 0))
